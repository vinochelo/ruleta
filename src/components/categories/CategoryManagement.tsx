...
const DEFAULT_CATEGORIES: Category[] = [
    { id: "default-objetos-uuid", name: "Objetos", words: ["Silla", "Mesa", "Lámpara", "Libro", "Teléfono", "Taza", "Reloj", "Gafas", "Llave", "Peine", "Tijeras", "Cuchara", "Botella", "Ventana", "Puerta", "Cuchillo", "Paraguas", "Martillo", "Escalera", "Micrófono", "Mochila", "Anillo", "Vaso", "Plato", "Cartera", "Bombilla", "Auriculares", "Mando a distancia", "Taladro", "Regla"], isActive: true },
    { id: "default-animales-uuid", name: "Animales", words: ["Perro", "Gato", "Elefante", "León", "Jirafa", "Tigre", "Oso", "Pájaro", "Serpiente", "Mariposa", "Pez", "Caballo", "Vaca", "Mono", "Cebra", "Pingüino", "Delfín", "Tiburón", "Canguro", "Koala", "Camello", "Zorro", "Lobo", "Águila", "Cocodrilo", "Rinoceronte", "Hipopótamo", "Ardilla", "Rana", "Búho"], isActive: true },
    { id: "default-comida-uuid", name: "Comida", words: ["Manzana", "Pizza", "Hamburguesa", "Pasta", "Helado", "Sushi", "Ensalada", "Pan", "Chocolate", "Queso", "Huevo", "Sopa", "Galleta", "Naranja", "Uvas", "Plátano", "Patatas fritas", "Tarta", "Yogur", "Café", "Arroz", "Pollo", "Pescado", "Maíz", "Tomate", "Pimiento", "Brócoli", "Zanahoria", "Cebolla", "Aguacate"], isActive: true },
    { id: "default-acciones-uuid", name: "Acciones", words: ["Correr", "Saltar", "Nadar", "Escribir", "Leer", "Cantar", "Bailar", "Cocinar", "Volar", "Pintar", "Dormir", "Comer", "Beber", "Conducir", "Llorar", "Reír", "Escalar", "Escuchar", "Pensar", "Aplaudir", "Abrazar", "Empujar", "Gritar", "Susurrar", "Construir", "Señalar", "Saludar", "Silbar", "Estornudar", "Pescar"], isActive: true },
    { id: "default-lugares-uuid", name: "Lugares", words: ["Playa", "Montaña", "Ciudad", "Bosque", "Desierto", "Parque", "Escuela", "Museo", "Hospital", "Restaurante", "Cine", "Supermercado", "Gimnasio", "Aeropuerto", "Estación de tren", "Biblioteca", "Banco", "Iglesia", "Castillo", "Isla", "Cueva", "Oficina", "Granja", "Teatro", "Puente", "Fábrica", "Universidad", "Volcán", "Laboratorio", "Circo"], isActive: true },
    { id: "default-personajes-uuid", name: "Personajes Famosos", words: ["Einstein", "Chaplin", "Picasso", "Mozart", "Cleopatra", "Da Vinci", "Marie Curie", "Shakespeare", "Gandhi", "Frida Kahlo", "Napoleón", "Beethoven", "Newton", "Michael Jackson", "Marilyn Monroe", "Elvis Presley", "Pelé", "Muhammad Ali", "Stephen Hawking", "Nelson Mandela", "Walt Disney", "Steve Jobs", "Bill Gates", "Madonna", "Beyoncé"], isActive: true },
    { id: "default-peliculas-uuid", name: "Películas y Series", words: ["Titanic", "Star Wars", "Friends", "Stranger Things", "Harry Potter", "El Padrino", "Juego de Tronos", "Breaking Bad", "Matrix", "Casablanca", "Forrest Gump", "Pulp Fiction", "Los Simpson", "El Rey León", "La Casa de Papel", "Jurassic Park", "E.T.", "The Office", "Volver al Futuro", "El Señor de los Anillos", "Vengadores", "Frozen", "Shrek", "Toy Story", "Indiana Jones"], isActive: true },
    { id: "default-profesiones-uuid", name: "Profesiones", words: ["Médico", "Profesor", "Bombero", "Policía", "Cocinero", "Astronauta", "Pintor", "Músico", "Actor", "Científico", "Ingeniero", "Abogado", "Periodista", "Carpintero", "Piloto", "Dentista", "Veterinario", "Juez", "Fotógrafo", "Electricista", "Jardinero", "Mecánico", "Peluquero", "Arquitecto", "Traductor", "Traductora", "Psicólogo", "Psicóloga", "Biólogo", "Bióloga", "Farmacéutico"], isActive: true },
    { id: "default-deportes-uuid", name: "Deportes", words: ["Fútbol", "Baloncesto", "Tenis", "Natación", "Béisbol", "Golf", "Boxeo", "Ciclismo", "Atletismo", "Esquí", "Voleibol", "Rugby", "Fórmula 1", "Surf", "Ajedrez", "Hockey", "Críquet", "Judo", "Kárate", "Gimnasia", "Bádminton", "Ping-pong", "Balonmano", "Remo", "Escalada", "Patinaje", "Esgrima", "Lucha libre", "Tiro con arco", "Hípica"], isActive: true },
    { id: "default-transporte-uuid", name: "Transporte", words: ["Coche", "Avión", "Barco", "Bicicleta", "Tren", "Autobús", "Motocicleta", "Helicóptero", "Submarino", "Cohete", "Globo aerostático", "Patinete", "Camión", "Tranvía", "Canoa", "Monopatín", "Yate", "Furgoneta", "Taxi", "Metro", "Velero", "Jet ski", "Caravana", "Triciclo", "Ambulancia", "Grúa", "Barcaza", "Sidecar", "Segway", "Teleférico"], isActive: true },
    { id: "default-naturaleza-uuid", name: "Naturaleza", words: ["Árbol", "Flor", "Río", "Sol", "Luna", "Estrella", "Nube", "Volcán", "Arcoíris", "Catarata", "Planta", "Roca", "Mar", "Relámpago", "Hoja", "Ola", "Arena", "Hielo", "Fuego", "Viento", "Montaña", "Isla", "Selva", "Glaciar", "Aurora boreal", "Tsunami", "Terremoto", "Meteorito", "Amanecer", "Atardecer"], isActive: true },
    { id: "default-hogar-uuid", name: "Cosas de Casa", words: ["Sofá", "Cama", "Ducha", "Nevera", "Horno", "Ventana", "Puerta", "Espejo", "Alfombra", "Televisión", "Microondas", "Aspiradora", "Plancha", "Tostadora", "Lavadora", "Armario", "Escritorio", "Bañera", "Inodoro", "Fregadero", "Estantería", "Cojín", "Cortina", "Escoba", "Olla", "Sartén", "Batidora", "Licuadora", "Exprimidor", "Perchero"], isActive: true },
    { id: "default-ropa-uuid", name: "Ropa", words: ["Camisa", "Pantalón", "Zapato", "Sombrero", "Vestido", "Falda", "Chaqueta", "Calcetines", "Bufanda", "Guantes", "Bikini", "Gorra", "Botas", "Pijama", "Corbata", "Sudadera", "Vaqueros", "Zapatillas", "Sandalias", "Abrigo", "Traje", "Camiseta", "Jersey", "Cinturón", "Gafas de sol", "Impermeable", "Chaleco", "Medias", "Bata", "Esmoquin"], isActive: true },
    { id: "default-cuerpo-uuid", name: "Partes del Cuerpo", words: ["Ojo", "Nariz", "Boca", "Mano", "Pie", "Cabeza", "Brazo", "Pierna", "Oreja", "Pelo", "Dedo", "Rodilla", "Codo", "Hombro", "Espalda", "Ceja", "Pestaña", "Uña", "Diente", "Lengua", "Cuello", "Pecho", "Estómago", "Tobillo", "Muñeca", "Cerebro", "Corazón", "Pulmón", "Costilla", "Barbilla"], isActive: true },
    { id: "default-instrumentos-uuid", name: "Instrumentos Musicales", words: ["Guitarra", "Piano", "Violín", "Batería", "Flauta", "Trompeta", "Saxofón", "Arpa", "Tambor", "Bajo", "Ukelele", "Acordeón", "Clarinete", "Trombón", "Xilófono", "Violonchelo", "Gaita", "Pandereta", "Triángulo", "Maracas", "Armónica", "Banjo", "Platillos", "Teclado", "Contrabajo", "Castanuelas", "Didyeridú", "Sitar", "Tuba", "Oboe"], isActive: true },
    { id: "default-marcas-uuid", name: "Marcas Famosas", words: ["Coca-Cola", "Nike", "Apple", "Google", "Amazon", "McDonald's", "Disney", "Toyota", "Samsung", "Adidas", "Pepsi", "IKEA", "Microsoft", "Ferrari", "Lego", "Starbucks", "Facebook", "Netflix", "Sony", "Ford", "Gucci", "Rolex", "Nintendo", "Red Bull", "Visa"], isActive: true },
    { id: "default-paises-uuid", name: "Países y Ciudades", words: ["España", "Francia", "Italia", "Japón", "China", "Estados Unidos", "Brasil", "Egipto", "Australia", "Rusia", "París", "Roma", "Londres", "Nueva York", "Tokio", "Sídney", "Pekín", "Moscú", "El Cairo", "Río de Janeiro", "Canadá", "México", "India", "Alemania", "Argentina"], isActive: true },
    { id: "default-cartoons-uuid", name: "Dibujos Animados", words: ["Mickey Mouse", "Bugs Bunny", "Homer Simpson", "Bob Esponja", "Pikachu", "Doraemon", "Goku", "Tom y Jerry", "Scooby-Doo", "Peppa Pig", "Pato Donald", "Snoopy", "Garfield", "Hello Kitty", "Popeye", "He-Man", "Superman", "Batman", "Spider-Man", "Winnie the Pooh", "Rick y Morty", "Phineas y Ferb", "Las Supernenas", "Pocoyó", "Naruto"], isActive: true },
    { id: "default-emociones-uuid", name: "Emociones", words: ["Alegría", "Tristeza", "Miedo", "Sorpresa", "Amor", "Ira", "Asco", "Vergüenza", "Confianza", "Interés", "Calma", "Ansiedad", "Culpa", "Orgullo", "Celos", "Esperanza", "Nostalgia", "Euforia", "Aburrimiento", "Soledad", "Gratitud", "Frustración", "Curiosidad", "Admiración", "Alivio"], isActive: true },
    { id: "default-meteorologia-uuid", name: "Fenómenos Meteorológicos", words: ["Lluvia", "Nieve", "Sol", "Tornado", "Relámpago", "Trueno", "Viento", "Niebla", "Granizo", "Arcoíris", "Huracán", "Sequía", "Inundación", "Ola de calor", "Aurora boreal", "Eclipse", "Monzón", "Ventisca", "Rocío", "Nube", "Tifón", "Ciclón", "Marea", "Escarcha", "Llovizna"], isActive: true }
];

const KIDS_CATEGORIES: Category[] = [
    { id: "kids-animales-uuid", name: "Animales Divertidos", words: ["Perro", "Gato", "Pez", "Pájaro", "Conejo", "León", "Elefante", "Jirafa", "Mono", "Vaca", "Cerdo", "Oveja", "Pollito", "Rana", "Mariposa", "Pato", "Caballo", "Tigre", "Oso", "Gallo"], isActive: true },
    { id: "kids-juguetes-uuid", name: "Juguetes", words: ["Pelota", "Muñeca", "Coche", "Tren", "Avión", "Lego", "Oso de peluche", "Cometa", "Yoyó", "Cubo", "Pala", "Robot", "Dinosaurio", "Bicicleta", "Patines", "Puzle", "Peonza", "Caleidoscopio", "Triciclo", "Hula-hoop"], isActive: true },
    { id: "kids-comida-uuid", name: "Comida Rica", words: ["Manzana", "Plátano", "Naranja", "Fresa", "Helado", "Pizza", "Tarta", "Galleta", "Huevo", "Leche", "Zumo", "Pan", "Queso", "Sopa", "Piruleta", "Sandía", "Cereales", "Yogur", "Caramelo", "Rosquilla"], isActive: true },
    { id: "kids-casa-uuid", name: "Cosas de Casa", words: ["Casa", "Puerta", "Ventana", "Cama", "Silla", "Mesa", "Lámpara", "Sofá", "Reloj", "Tele", "Baño", "Plato", "Vaso", "Cuchara", "Libro", "Cuna", "Armario", "Ducha", "Jarrón", "Alfombra"], isActive:true },
    { id: "kids-naturaleza-uuid", name: "Naturaleza", words: ["Sol", "Luna", "Estrella", "Nube", "Lluvia", "Arcoíris", "Árbol", "Flor", "Río", "Montaña", "Mar", "Playa", "Hierba", "Piedra", "Hoja", "Seta", "Nido", "Catarata", "Caracol", "Mariquita"], isActive: true },
    { id: "kids-formas-colores-uuid", name: "Formas y Colores", words: ["Círculo", "Cuadrado", "Triángulo", "Estrella", "Corazón", "Rojo", "Azul", "Amarillo", "Verde", "Blanco", "Negro", "Naranja", "Rosa", "Morado", "Marrón", "Rectángulo", "Óvalo", "Rombo", "Cilindro", "Cubo"], isActive: true }
];

const BIBLICAL_CATEGORIES: Category[] = [
    { id: "bible-ot-personajes-uuid", name: "Personajes (Antiguo Test.)", words: ["Adán", "Eva", "Noé", "Abraham", "Moisés", "David", "Salomón", "Sansón", "Ester", "Rut", "Isaías", "Jeremías", "Daniel", "Jonás", "José", "Caín", "Abel", "Jacob", "Josué", "Gedeón"], isActive: true },
    { id: "bible-nt-personajes-uuid", name: "Personajes (Nuevo Test.)", words: ["Jesús", "María", "José", "Pedro", "Pablo", "Juan Bautista", "Lázaro", "Marta", "Zaqueo", "Pilato", "Judas", "Magdalena", "Lucas", "Mateo", "Santiago", "Herodes", "Caifás", "Barrabás", "Simeón", "Elías"], isActive: true },
    { id: "bible-historias-uuid", name: "Historias Bíblicas", words: ["Creación", "Arca de Noé", "Torre de Babel", "Mar Rojo", "Diez Mandamientos", "David y Goliat", "Multiplicación de panes", "El hijo pródigo", "Parábola del sembrador", "La crucifixión", "La resurrección", "Ascensión", "Pentecostés", "Caída de Jericó", "El buen samaritano", "Nacimiento de Jesús", "Bautismo de Jesús", "La última cena", "Sodoma y Gomorra", "Juicio de Salomón"], isActive: true },
    { id: "bible-objetos-uuid", name: "Objetos y Símbolos", words: ["Arca de la Alianza", "Tabla de la Ley", "Honda de David", "Maná", "Zarza ardiente", "Cordero", "Paloma", "Pez", "Cruz", "Copa", "Corona de espinas", "Túnica", "Sandalias", "Lámpara de aceite", "Red de pescar", "Clavos", "Lanza", "Estrella de Belén", "Incienso", "Mirra"], isActive: true },
    { id: "bible-lugares-uuid", name: "Lugares Bíblicos", words: ["Jardín del Edén", "Monte Sinaí", "Jerusalén", "Belén", "Nazaret", "Mar de Galilea", "Río Jordán", "Templo", "Egipto", "Tierra Prometida", "Pozo de Jacob", "Monte de los Olivos", "Jericó", "Damasco", "Gólgota", "Caná", "Capernaúm", "Antioquía", "Babilonia", "Nínive"], isActive: true }
];
